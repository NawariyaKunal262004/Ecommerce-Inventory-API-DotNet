...
public class GetMedicineBatchesQueryHandler : IRequestHandler<GetMedicineBatchesQuery, ResponseModel>
{
    private readonly IMedicineBatchRepository _batchRepository;
    private readonly IMedicineRepository _medicineRepository;

    public GetMedicineBatchesQueryHandler(
    ...
    public async Task<ResponseModel> Handle(GetMedicineBatchesQuery request, CancellationToken cancellationToken)
    {
